...
public class NoticeAppriseAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int cnt = dao.apprise_Listcnt(key, search);
		...
		List<appriseVO> list = dao.apprise_List(liststart, listend, key, search);
		
		String pageSkip = PageIndex.pageList(page, totpage, "SYKK?command=notice_apprise", addtag);
		...
		request.getRequestDispatcher("notice/apprise.jsp").forward(request, response);
	}
