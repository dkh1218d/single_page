...
<div class="contain">
	...
	<div class="write-form">
		<table summery="질문답변 글쓰기 테이블 입니다">
			<caption class="readonly">QnA입력폼</caption>			
			<colgroup>
				<col width="20%">
				<col width="80%">
			</colgroup>
			<tbody>
			<form name="my" method="post" action="SYKK?command=board_qna_write_pro" onsubmit="return formcheck();">
					<tr>
						<th>질문유형</th>
						<td>
							<select name="questions" class="sel">
								<option value="none_select">선택하세요</option>
								<option value="직업">작업</option>
