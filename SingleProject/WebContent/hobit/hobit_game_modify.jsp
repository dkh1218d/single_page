...
<div class="contain">
	...
	<form name="hobit" method="post" enctype="multipart/form-data">
		<table>
			<caption class="readonly">게임 다이어리</caption>			
			<colgroup>
				<col class="w20">
				<col class="w80">
			</colgroup>
...
<script>
	...
	function go_list(page){
		location.href="SYKK?command=hobit_game&page="+page;
	}
	...
	function fileCheck(idx, page) {
		...
		if(hobit.photo.value=="") {
			hobit.action="SYKK?command=hobit_game_modify_pro&idx="+idx+"&page="+page;
			hobit.submit();
			return;
		}
