...
<div class="contain">
	...
	<div class="write-form">
		<table summery="갤러리 글쓰기 테이블 입니다">
			...
			<tbody>
			<form name="my" method="post" action="SYKK?command=gallery_f_modify_pro&idx=${vo.idx}" enctype="multipart/form-data" onsubmit="return formcheck();">
					<tr>
						<th>제목</th>
...
<script>
	...
	function go_list(){
		location.href="SYKK?command=gallery_f";
	}
	function formcheck() {
		if(my.subject.value=="") {
			alert("제목입력하세요");
