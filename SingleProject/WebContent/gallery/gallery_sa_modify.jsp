...
<div class="contain">
	...
	<div class="write-form">
		<table summery="갤러리 글쓰기 테이블 입니다">
			...
			<tbody>
			<form name="my" method="post" action="SYKK?command=gallery_sa_modify_pro&idx=${vo.idx}" enctype="multipart/form-data" onsubmit="return formcheck();">
					<tr>
						<th>제목</th>
						<td><input type="text" name="subject" value="${vo.subject}" maxlength="30"></td>
					</tr>
					<tr>
						<th>내용</th>
					...
					<tr>
						<th>첨부</th>
						<td><input type="file" name="photo" accept="image/*" Id="sa_file" multiple="multiple"></td>
					</tr>
					<tr>
						<td colspan="2">
...
<script>
	...
	function go_list(){
		location.href="SYKK?command=gallery_sa";
	}
	function formcheck() {
		if(my.subject.value=="") {
			alert("제목입력하세요");
